...
public class Libro {
     ...
     */
    public Libro(String idLibro, String tituloLibro, Proveedor proveedor, String autor, float costo, String ISBN) {
        this.idLibro = idLibro;
    ...
    /**
     * Metodo que regresa el valor del 
     * atributo proveedor de la clase.
     ...
     * al valor de su parametro.
     * @param proveedor Proveedor del libro a establecer
     */
